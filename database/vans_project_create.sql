...
-- Last modification date: 2023-05-18 10:47:24.034
...
ALTER TABLE driver ADD CONSTRAINT driver_van
    FOREIGN KEY (van_id)
    REFERENCES van (id)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
...
ALTER TABLE maintenance ADD CONSTRAINT maintenance_van
    FOREIGN KEY (van_id)
    REFERENCES van (id)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
...
ALTER TABLE mileage ADD CONSTRAINT mileage_van
    FOREIGN KEY (van_id)
    REFERENCES van (id)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
...
ALTER TABLE van ADD CONSTRAINT van_city
    FOREIGN KEY (city_id)
    REFERENCES city (id)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
...
ALTER TABLE van ADD CONSTRAINT van_insurance
